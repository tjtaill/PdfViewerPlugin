...
public class PDFViewer extends JPanel
        ...
        PageChangeListener, EBComponent, DefaultFocusComponent {
...
//        System.out.println("Going to page " + pagenum);
    ...
    class PrintThread extends Thread {
        ...
        com.sun.pdfview.PDFPrintPage ptPages;
        PrinterJob ptPjob;

        public PrintThread(com.sun.pdfview.PDFPrintPage pages, PrinterJob pjob) {
            ptPages = pages;
            ptPjob = pjob;
            setName(getClass().getName());
        }
    ...
    public void doPrint() {
        ...
        Book book = new Book();
        com.sun.pdfview.PDFPrintPage pages = new PDFPrintPage(curFile);
    ...
    public void syncTextLocation(org.gjt.sp.jedit.textarea.TextArea textArea) {
        ...
        float percent = (float) (curpage + 1)/pages;
